                    ...
                    <table class=" table  w-full" style="font-size: 1.5em;">
                        <tr>
                            <td width=30% class="text-left">
                                <?php echo e($item->medicament, false); ?> ( <?php echo e($item->posologie, false); ?> Fois/jour )
                            </td>
                        </tr>
                    </table>
...
</html><?php /**PATH /var/www/vhosts/clickdoc.ma/clickdoc-final/backend-final/resources/views/ordonnance.blade.php ENDPATH**/ ?>