				...
				<table class="w-full table font-semibold ">
					<tr>
						...
						<td class="text-center">
							<?php echo e($patient->name, false); ?> <?php echo e($patient->surname, false); ?>
					...
					<tr>
						...
						<td class="text-center">
							<?php if(isset($patient->coverage_number)): ?> 
								<?php echo e($patient->coverage_number, false); ?>
					...
					<tr>
						...
						<td class="text-center uppercase">
							<?php if(isset($patient->CIN)): ?>
								<?php echo e($patient->CIN, false); ?>
						...
						<td class="text-center">
							<div class="grid grid-cols-5">
									...
									<div class="text-center col-span-3">
										<?php echo e($facture->amount, false); ?>
			...
			<div class="mx-8 border-black border-2">
				<table class="w-full table font-semibold">
					...
					<tr>
						...
						<td class="text-center">
							<?php if(isset($patient->date_of_birth)): ?>
								<?php echo e($patient->date_of_birth, false); ?>
...
</html><?php /**PATH /var/www/vhosts/clickdoc.ma/clickdoc-final/backend-final/resources/views/cnss.blade.php ENDPATH**/ ?>